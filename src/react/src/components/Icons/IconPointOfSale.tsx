// icon:point-of-sale | Material Design Icons https://materialdesignicons.com/ | Austin Andrews
import * as React from 'react';

function IconPointOfSale(props: React.SVGProps<SVGSVGElement>) {
  return (
...
export default IconPointOfSale;
